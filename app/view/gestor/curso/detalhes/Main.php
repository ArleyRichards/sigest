                    ...
                    <div class="invoice p-3 mb-3">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <h4>
                                    ...
                                    <small class="float-right"><a href="<?= DIRPAGE . 'curso/edicao/' . $curso['id'] ?>" class="btn btn-outline-info">Alterar Informações</a></small>
                                </h4>
                            </div>
                            <!-- /.col -->
                        </div>
                        ...
                        <div class="row mt-3">                           
                            ...
                            if (isset($rowTurma) && $rowTurma != null) {
                                ...
                                echo '<h6 class="text-muted"> Não há turmas abertas para esse curso</h6>';
                            }
                            ?>
                        </div>
                        <!-- Table row -->
