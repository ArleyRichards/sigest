                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="../atualizar" method="post">
                                <input type="hidden" name="id_curso" value="<?= $rowCurso['id'] ?>"> 
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="nome" id="campo-nome" class="form-control" maxlength="255" value="<?= $rowCurso['nome']?>" required>
                                </div>   
                                <div class="row">
                                    <div class="form-group mb-3 col-12 col-lg-6">
                                        <label for="select-nivel">Nível <span class="text-danger"> *</span></label>
                                        <select class="form-control" name="nivel">
                                            <option value="<?= $rowCurso['nivel']?>" selected><?= $rowCurso['nivel']?></option>
                                    ...
                                    <div class="form-group mb-3 col-12 col-lg-6">
                                        ...
                                        <input type="text" name="ch" id="campo-ch" maxlength="20" class="form-control" value="<?= $rowCurso['carga_horaria']?>" required>
                                    </div>
                                </div>                 
                                <div class="row">
                                    <div class="form-group mb-3 col-12 col-lg-12">
                                        <label for="campo-descricao">Descrição</label>
                                        <textarea name="descricao" class="form-control" rows="7" maxlength="1000" resizable="false" style="resize: none"><?= $rowCurso['descricao']?></textarea>
                                    </div>
                                </div>
