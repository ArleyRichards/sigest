...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Cadastrar Discente</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                        ...
                        <div class="card-body">
                            <form action="salvar" method="post">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="nome-mae" id="campo-nome-mae" class="form-control" maxlength="255" required>
                                </div>
                                <div class="form-group mb-3">
                                    <label for="campo-nome-pai">Nome do Pai</label>
                                    <input type="text" name="nome-pai" id="campo-nome-pai" class="form-control" maxlength="255">
                                </div>
                                <div class="row">
                                    <div class="form-group mb-3 col-12 col-lg-4">
                                        <label for="campo-nascimento">Data de Nascimento<span class="text-danger"> *</span></label>
                                        <input type="date" name="nascimento" id="campo-nascimento" class="form-control">
                                    </div>
                                    <div class="form-group mb-3 col-12 col-lg-4">
                                        <label for="campo-cpf">CPF<span class="text-danger"> *</span></label>
                                        <input type="text" name="cpf" id="campo-cpf" maxlength="20" class="form-control">
                                    </div>
                                    <div class="form-group mb-3 col-12 col-lg-4">
                                        <label for="campo-rg">RG<span class="text-danger"> *</span></label>
                                        <input type="text" name="rg" id="campo-rg" maxlength="20" class="form-control">
                                    </div>
                                </div>                 
                                <div class="row">
                                    ...
                                    <div class="form-group mb-3 col-12 col-lg-6">
                                        ...
                                        <input type="tel" name="telefone" id="campo-telefone" class="form-control">
                                    </div>
                                </div>
                                <div class="row">
