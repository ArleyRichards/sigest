         ...
         <div class="col-md-4">
           ...
           <div class="card card-primary card-outline">
             <div class="card-body box-profile">
               ...
               <?php
                $discente = $this->getData()['discente'][0];
                $instituicao = $this->getData()['instituicao'][0];
                //var_dump($this->getData());
               ?>

               <h3 class="profile-username text-center"><?=$discente['nome']?></h3>
               <p class="text-center mb-0">Matrícula: <strong><?=$discente['id']?></strong></p>
               <p class="text-muted text-center mt-0">[<?=$discente['id_instituicao'].'] - '.$instituicao['nome_fantasia']?></p>

               <a href="<?=DIRPAGE.'discente/edicao/'.$discente['id']?>" class="btn btn-primary btn-block"><b>Editar</b></a>
             </div>
             <!-- /.card-body -->
           </div>
           <!-- /.card -->
           ...
           <div class="card card-primary">
             ...
             <div class="card-body">
               ...
               <p class="text-muted">
                 <span class="tag tag-danger"><?=$discente['telefone']?></span></br>                 
               </p>
               <hr>
               <strong><i class="fas fa-at mr-1"></i> Email</strong>

               <p class="text-muted"><?=$discente['email']?></p>
             </div>
             <!-- /.card-body -->
           </div>
           <!-- /.card -->
