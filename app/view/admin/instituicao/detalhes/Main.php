         ...
         <div class="col-md-4">
           ...
           <div class="card card-primary card-outline">               
             <div class="card-body box-profile">
               ...
               <p class="text-muted text-center">INSTITUIÇÃO <?=$instituicao['regime']?></p>

               <a href="<?=DIRPAGE.'instituicao/edicao/'.$instituicao['id']?>" class="btn btn-primary btn-block"><b>Editar</b></a>
             </div>
             <!-- /.card-body -->
           </div>
           <!-- /.card -->
           ...
           <div class="card card-primary">
             ...
             <div class="card-body">
               ...
               <p class="text-muted"><?=$instituicao['endereco'].' - '.$instituicao['numero']?></br>
               <?=$instituicao['cidade'].' - '.$instituicao['uf']?></p>

               <hr>

               <strong><i class="fas fa-phone mr-1"></i> Telefones</strong>

               <p class="text-muted">
                 <span class="tag tag-danger"><?=$instituicao['telefone_1']?></span></br>
                 <?php
                 if($instituicao['telefone_2'] != ''){
                  echo '<span class="tag tag-danger">'.$instituicao['telefone_2'].'</span></br>';
                  }
                 ?>
               </p>
               ...
               <p class="text-muted"><?=$instituicao['email']?></p>
             </div>
             <!-- /.card-body -->
           </div>
           <!-- /.card -->
