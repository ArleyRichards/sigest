                 ...
                 <tbody>
                   <?php
                    ...
                    foreach ($rowInstituicao as $key => $instituicao) {
                      echo '<tr>';
                      echo '<td><a href="'.DIRPAGE.'instituicao/detalhes/'.$instituicao['id'].'" style="cursor: pointer" class="list-group-item-action">' . $instituicao['id'] . '</a></td>';
                      echo '<td><a href="'.DIRPAGE.'instituicao/detalhes/'.$instituicao['id'].'" style="cursor: pointer" class="list-group-item-action">' . $instituicao['nome_fantasia'] . '</a></td>';
                      echo '<td>' . $instituicao['cidade'] . '</td>';
                      echo '<td>' . $instituicao['uf'] . '</td>';
                      echo '</tr>';
                    }
                    ?>
                 </tbody>
