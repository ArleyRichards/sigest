               ...
               <form action="../atualizar" method="post">
                <input type="hidden" name="id" value="<?=$instituicao['id']?>">
                 <div class="form-group mb-3">
                   ...
                   <input type="text" name="razao-social" id="campo-razao" class="form-control" value="<?=$instituicao['razao_social']?>" required>
                 </div>
                 <div class="form-group mb-3">
                   <label for="campo-fantasia">Nome Fantasia</label>
                   <input type="text" name="nome-fantasia" id="campo-fantasia" class="form-control" value="<?=$instituicao['nome_fantasia']?>"  required>
                 </div>
                 <div class="row">
                   <div class="form-group mb-3 col-12 col-lg-6">
                     <label for="campo-cnpj">CNPJ</label>
                     <input type="text" name="cnpj" id="campo-cnpj" class="form-control" value="<?=$instituicao['cnpj']?>"  required>
                   </div>
                   <div class="form-group mb-3 col-12 col-lg-6">
                     <label for="campo-inscricao">Inscrição Estadual</label>
                     <input type="text" name="inscricao-estadual" id="campo-inscricao" class="form-control" value="<?=$instituicao['inscricao_estadual']?>"  required>
                   </div>
                 </div>
                 <div class="row">
                   <div class="form-group mb-3 col-12 col-lg-3">
                     <label for="select-regime">Regime</label>
                     <select name="regime" id="select-regime" class="form-control" value="<?=$instituicao['regime']?>" required>
                   ...
                   <div class="form-group mb-3 col-12 col-lg-9">
                     ...
                     <input type="text" name="site" id="campo-site" class="form-control" value="<?=$instituicao['site']?>" >
                   </div>
                 </div>
                 <div class="row">
                   <div class="form-group mb-3 col-12 col-lg-9">
                     <label for="campo-email">Email</label>
                     <input type="email" name="email" id="campo-email" class="form-control" value="<?=$instituicao['email']?>"  required>
                   </div>
                 ...
                 <div class="row">
                   <div class="form-group mb-3 col-12 col-lg-6">
                     ...
                     <input type="text" name="cidade" id="campo-cidade" class="form-control" value="<?=$instituicao['cidade']?>"  required>
                   </div>
                   <div class="form-group mb-3 col-12 col-lg-6">
                     <label for="campo-bairro">Bairro</label>
                     <input type="text" name="bairro" id="campo-bairro" class="form-control" value="<?=$instituicao['bairro']?>"  required>
                   </div>
                 </div>
                 <div class="row">
                   <div class="form-group mb-3 col-12 col-lg-8">
                     <label for="campo-logradouro">Logradouro</label>
                     <input type="text" name="logradouro" id="campo-logradouro" class="form-control" value="<?=$instituicao['endereco']?>"  required>
                   </div>
                   <div class="form-group mb-3 col-3 col-lg-1">
                     <label for="campo-numero">Número</label>
                     <input type="text" name="numero" id="campo-numero" class="form-control" value="<?=$instituicao['numero']?>" >
                   </div>
                   <div class="form-group mb-3 col-9 col-lg-3">
                     <label for="campo-cep">Cep</label>
                     <input type="text" name="cep" id="campo-cep" class="form-control" value="<?=$instituicao['cep']?>"  required>
                   </div>
                 </div>
                 <div class="row">
                   <div class="form-group mb-3 col-12 col-lg-6">
                     <label for="campo-telefone">Telefone</label>
                     <input type="tel" name="telefone" id="campo-telefone" class="form-control" value="<?=$instituicao['telefone_1']?>"  required>
                   </div>
                   <div class="form-group mb-3 col-12 col-lg-6">
                     <label for="campo-telefone2">Telefone 2</label>
                     <input type="tel" name="telefone2" id="campo-telefone2" class="form-control" value="<?=$instituicao['telefone_2']?>" >
                   </div>                                    
                 </div>
                 <div class="text-end">
